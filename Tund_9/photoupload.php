		...
		if(!empty($_FILES["fileToUpload"]["name"])){
			...
			// kui kõik korras, laeme üles
				...
				if($imageFileType == "gif"){
				 ...
				 //alpha 0...127
				 //imagettftext($myImage, 20, -43, 10, 25, $textColor, "../vp_picfiles/ARIALNI.TTF", $textToImage); //ttf - true time font
				 imagettftext($myImage, 20, 0, 10, 25, $textColor, "../vp_picfiles/ARIALNI.TTF", $textToImage); //ttf - true time font
				 //üles laetud pildi saab näha aadressil näiteks "http://greeny.cs.tlu.ee/~darikre/veebiprogrammeerimine/picuploads/vp_15414025617810.jpg"
...
/* 				if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
	...
	function resizeImage($image, $ow, $oh, $w, $h){ //ow-original width
