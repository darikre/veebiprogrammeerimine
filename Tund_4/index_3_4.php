<?php
  ...
  $todayDate= date("m");
  $todayDate= date("Y");
  // kuu nimi eesti keeles
  $todayDate= date("m");
  echo $todayDate = date("m");
  $todayDateET = ["jaanuar", "veebruar", "märts", "aprill", "mai", "juuni", "juuli", "august", "september", "november", "detsember"];
  var_dump ($todayDateET);
  echo $todayDateET[0];
...
<body>
  ...
  echo "<p>Täna on: " .$weekDayNamesET[$weekDayNow - 1] .", " .$todayDate= date("d") .", " .$todayDateET [$todayDate - 1] .", " .$todayDate= date("Y") ."</p> \n";
